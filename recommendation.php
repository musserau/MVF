...
<div id="page">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-lg-9 inner-page ">
            <h3 class="text-center titleConf">FAIRE UNE RECOMMENDATION</h3>
            <br>
            <form method="post" id="formProblem" action="./recommendationOk.php">
                <div class="blockProblem">
                    ...
                    <div class="form-group">
                        <input class="form-control sujetProblem " placeholder="Objet recommendation"  name="sujetProblem" id="sujetProblem" type="text">
                    </div>
                    <div class="form-group">
