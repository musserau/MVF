        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-lg-9 inner-page ">
                ...
                <div class="blockProblem">
                    ...
                    $baseRequest = " INSERT INTO`tb_recommendation` (id_utilisateur,sujet,message) VALUES ((select id_utilisateur from tb_utilisateur where id_user=:user),:sujet,:problem)";
                    $dbh = getConnection();
